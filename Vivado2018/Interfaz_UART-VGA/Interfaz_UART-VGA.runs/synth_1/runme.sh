...
HD_PWD='C:/Users/Lenovo/Desktop/Sistemas Digitales/digisist/Vivado2018/Interfaz_UART-VGA/Interfaz_UART-VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log interfaz_UART_VGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source interfaz_UART_VGA.tcl
