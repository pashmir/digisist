...
HD_PWD='C:/Users/Lenovo/Desktop/Sistemas Digitales/digisist/Vivado2018/Interfaz_UART-VGA/Interfaz_UART-VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interfaz_UART_VGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interfaz_UART_VGA.tcl -notrace
