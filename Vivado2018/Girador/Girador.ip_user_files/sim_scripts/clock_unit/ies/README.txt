...
#
# Generated by export_simulation on Wed Oct 30 20:14:17 -0300 2019
#
################################################################################
...
'-reset_run' switch to the './clock_unit.sh' script.

./clock_unit.sh -reset_run
...
./clock_unit.sh -noclean_files

For more information on the script, please type './clock_unit.sh -help'.
