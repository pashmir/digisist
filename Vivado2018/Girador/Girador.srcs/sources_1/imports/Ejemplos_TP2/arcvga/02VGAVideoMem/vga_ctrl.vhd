...
component video_mem_wrapper is --se tiene que ir
   port (
...
component char_rom --se tiene que ir
    generic(
		N: integer:= 6;
		M: integer:= 3;
		W: integer:= 8
...
memoria_video: Video_mem_wrapper --esto se tiene que ir
           port map (
...
chars: char_rom--se tiene que ir
    port map(
...
process (rx_rdy,rst,clk50) -- este process se tiene que ir
    variable conteo : integer := 0;
