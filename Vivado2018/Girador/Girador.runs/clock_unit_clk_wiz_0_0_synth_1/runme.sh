...
HD_PWD='D:/Users/Ceci/Documents/Facu/digisist/Vivado2018/Girador/Girador.runs/clock_unit_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_unit_clk_wiz_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_unit_clk_wiz_0_0.tcl
