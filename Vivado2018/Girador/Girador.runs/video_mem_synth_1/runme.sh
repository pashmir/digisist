...
HD_PWD='D:/Users/Ceci/Documents/Facu/digisist/Vivado2018/Girador/Girador.runs/video_mem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log video_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source video_mem.tcl
