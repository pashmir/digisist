...
HD_PWD='C:/Users/alumno/Documents/GitHub/digisist-master/Vivado2018/Girador/Girador.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log girador.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source girador.tcl -notrace
