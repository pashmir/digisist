...
HD_PWD='C:/Users/alumno/Documents/GitHub/digisist-master/Vivado2018/Girador/Girador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log girador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source girador.tcl
