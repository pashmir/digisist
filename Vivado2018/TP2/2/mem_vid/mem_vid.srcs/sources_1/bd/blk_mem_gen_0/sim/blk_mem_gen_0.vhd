...
entity blk_mem_gen_0 is
  ...
  attribute CORE_GENERATION_INFO of blk_mem_gen_0 : entity is "blk_mem_gen_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=blk_mem_gen_0,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of blk_mem_gen_0 : entity is "blk_mem_gen_0.hwdef";
end blk_mem_gen_0;

architecture STRUCTURE of blk_mem_gen_0 is
  component blk_mem_gen_0_blk_mem_gen_0_0 is
  port (
    clka : in STD_LOGIC;
    ena : in STD_LOGIC;
  ...
  end component blk_mem_gen_0_blk_mem_gen_0_0;
  ...
  signal dina_0_1 : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clka_0 : signal is "XIL_INTERFACENAME CLK.CLKA_0, CLK_DOMAIN blk_mem_gen_0_clka_0, FREQ_HZ 100000000, PHASE 0.000";
  attribute X_INTERFACE_INFO of clkb_0 : signal is "xilinx.com:signal:clock:1.0 CLK.CLKB_0 CLK";
  attribute X_INTERFACE_PARAMETER of clkb_0 : signal is "XIL_INTERFACENAME CLK.CLKB_0, CLK_DOMAIN blk_mem_gen_0_clkb_0, FREQ_HZ 100000000, PHASE 0.000";
begin
  addra_0_1(18 downto 0) <= addra_0(18 downto 0);
  addrb_0_1(18 downto 0) <= addrb_0(18 downto 0);
  clka_0_1 <= clka_0;
  clkb_0_1 <= clkb_0;
  dina_0_1(2 downto 0) <= dina_0(2 downto 0);
  doutb_0(2 downto 0) <= blk_mem_gen_0_doutb(2 downto 0);
  ena_0_1 <= ena_0;
  enb_0_1 <= enb_0;
  wea_0_1(0) <= wea_0(0);
video_mem: component blk_mem_gen_0_blk_mem_gen_0_0
     port map (
      addra(18 downto 0) => addra_0_1(18 downto 0),
      addrb(18 downto 0) => addrb_0_1(18 downto 0),
      clka => clka_0_1,
      clkb => clkb_0_1,
      dina(2 downto 0) => dina_0_1(2 downto 0),
