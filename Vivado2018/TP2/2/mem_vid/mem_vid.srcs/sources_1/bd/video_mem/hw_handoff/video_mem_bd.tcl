...
################################################################
# This is a generated script based on design: video_mem
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra_0 [ create_bd_port -dir I -from 18 -to 0 addra_0 ]
  set addrb_0 [ create_bd_port -dir I -from 18 -to 0 addrb_0 ]
  set clka_0 [ create_bd_port -dir I -type clk clka_0 ]
  set clkb_0 [ create_bd_port -dir I -type clk clkb_0 ]
  set dina_0 [ create_bd_port -dir I -from 0 -to 0 dina_0 ]
  set doutb_0 [ create_bd_port -dir O -from 0 -to 0 doutb_0 ]
