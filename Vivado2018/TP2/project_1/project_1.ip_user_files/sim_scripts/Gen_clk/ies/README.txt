...
#
# Generated by export_simulation on Thu Dec 06 17:09:29 -0300 2018
#
################################################################################
...
'-reset_run' switch to the './Gen_clk.sh' script.

./Gen_clk.sh -reset_run
...
./Gen_clk.sh -noclean_files

For more information on the script, please type './Gen_clk.sh -help'.
