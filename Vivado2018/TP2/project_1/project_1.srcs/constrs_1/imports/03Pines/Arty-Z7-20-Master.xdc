...
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { rgb[2] }]; #IO_L22N_T3_34 Sch=JA4_N
...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { rgb[1] }]; #IO_L1N_T0_34 Sch=JB2_N
